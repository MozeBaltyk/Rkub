...
<!-- Autogenerated -->
**Ansible Collection Rkub 1.0.4 include:**

- [RKE2 1.28.10](https://docs.rke2.io) - Security focused Kubernetes

- [Kube-vip 0.8.0](https://kube-vip.io/) - Virtual IP and load balancer

- [Cert-manager 1.15.0](https://cert-manager.io/docs/) - Certificate manager

- [Rancher 2.8.5](https://www.suse.com/products/suse-rancher/) - Multi-Cluster Kubernetes Management
